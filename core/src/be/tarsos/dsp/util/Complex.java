...
public class Complex {
  ...
  /**
   * Principal branch of the Complex logarithm of this Complex number. (doesn't
   * change this Complex number). The principal branch is the branch with -pi <
   * arg <= pi. @ <p/>
   * <p
   * />
   * r
   * eturn log(z) where z is this Complex number.
   */
  public Complex log() {
  ...
  /**
   * Negative of this complex number (chs stands for change sign). This produces
   * a new Complex number and doesn't change this Complex number.
   * <br>-(x+i*y) = -x-i*y.
   *
   * @return -z where z is this Complex number.
   */
