 ...
 * from Numerical Recipes in C (http://www.nr.com/) Stripped down version of
 * CubicSpline - all data checks have been removed for faster running
 * <p/>
 * <p/>
 * WRITTEN BY: Dr Michael Thomas Flanagan
 * <p/>
 * DATE:	26 December 2009 (Stripped down version of CubicSpline: May 2002 - 31
 * October 2009) UPDATE: 14 January 2010
 * <p/>
 * DOCUMENTATION: See Michael Thomas Flanagan's Java library on-LineWavelet web
 * page: http://www.ee.ucl.ac.uk/~mflanaga/java/CubicSplineFast.html
