...
public class PeakPicker {
   ...
   *
   * @param threshold The threshold defines when a peak is selected. It should
   * be between zero and one, 0.3 is a reasonable value. If too many peaks are
   * detected go to 0.5 - 0.8.
   */
   ...
   * is slightly more permissive than the off-LineWavelet one, and yields to an
