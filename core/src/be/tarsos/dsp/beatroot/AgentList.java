...
/**
 * Class for maintaining the set of all Agents involved in beat tracking a piece
 * of music. Implements a simple linked list terminated by an AgentList with a
 * null Agent (ag).
 */
public class AgentList {

  /**
   * Flag for choice between sum and average beat salience values for Agent
   * scores. The use of summed saliences favours faster tempi or lower metrical
   * levels.
   */
  ...
  /**
   * For the purpose of removing duplicate agents, the JND of IBI. Not changed
   * in the current version.
   */
  public static double thresholdBI = DEFAULT_BI;

  /**
   * For the purpose of removing duplicate agents, the JND of phase. Not changed
   * in the current version.
   */
  ...
  /**
   * Sorts the AgentList by increasing beatInterval, using a bubble sort since
   * it is assumed that the list is almost sorted.
   */
  public void sort() {
  ...
  /**
   * Removes the current item from the list. The current item does not need to
   * be the head of the whole list.
   *
  ...
  /**
   * Removes Agents from the list which are duplicates of other Agents. A
   * duplicate is defined by the tempo and phase thresholds thresholdBI and
   * thresholdBT respectively.
   */
