...
public class HaarWaveletTransform {
  ...
  /**
   * Does an in-place HaarWavelet wavelet transform. The length of data needs to
   * be a power of two. It is based on the algorithm found in "Wavelets Made
   * Easy" by Yves Nivergelt, page 24.
   *
  ...
  /**
   * Does an in-place inverse HaarWavelet Wavelet Transform. The data needs to
   * be a power of two. It is based on the algorithm found in "Wavelets Made
   * Easy" by Yves Nivergelt, page 29.
   *
   ...
   * operators. e.g. 4 in binary format is "0000 0000 0000 0000 0000 0000 0000
   * 0100"; and -4 is "1111 1111 1111 1111 1111 1111 1111 1100"; and 4&-4 will
   * be "0000 0000 0000 0000 0000 0000 0000 0100";
   *
