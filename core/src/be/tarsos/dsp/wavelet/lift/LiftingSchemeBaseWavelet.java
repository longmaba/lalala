...
public abstract class LiftingSchemeBaseWavelet {
   ...
   * are in the first half of the vector and the odd elements are in the second
   * half.
   */
  ...
  /**
   * Merge the odd elements from the second half of the N element region in the
   * array with the even elements in the first half of the N element region. The
   * result will be the combination of the odd and even elements in a region of
   * length N.
   */
   ...
   * <p/>
   * <p>
   * forwardTrans is passed an array of doubles. The array size must be a power
   * of two. Lifting Scheme wavelet transforms are calculated in-place and the
   * result is returned in the argument array.
   * </p>
   * <p/>
   * <p>
   ...
   * transform is calculated in-place and the result is returned in the argument
   * array.
   * </p>
   *
   * @param vec the vector
