...
class PolynomialInterpolation {
  ...
  /**
   * <p>
   * For the polynomial interpolation point x-coordinate <b><i>x</i></b>, return
   * the associated polynomial interpolation coefficients.
   * </p>
   *
   ...
   * @param d an array containing the y-coordinate values for the known points
   * (which are located at x-coordinates 0..N-1).
