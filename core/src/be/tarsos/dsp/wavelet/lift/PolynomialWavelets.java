...
public class PolynomialWavelets extends LiftingSchemeBaseWavelet {
   ...
   * algebraic manipulation, solving for the even element given the average and
   * the odd element.
   * </p>
   * <p>
   ...
   * We pretend that these four points are located at the x-coordinates 0,1,2,3.
   * The first odd point interpolated will be located between the first and
   * second even point, at 0.5. The next N-3 points are located at 1.5 (in the
   * middle of the four points). The last two points are located at 2.5 and 3.5.
   ...
   * 4, linear interpolation is used. When N = 2, HaarWavelet interpolation is
   * used (the prediction for the odd value is that it is equal to the even
   * value).
   * </p>
   *
