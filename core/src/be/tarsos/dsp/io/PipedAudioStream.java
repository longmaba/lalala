 ...
 * about any audio format to a one channel PCM stream of a chosen sample rate.
 * There is support for movie files as well, the first audio channel is then
 * used as input. The resource is either a local file or a type of stream
 * supported by libAV (e.g. HTTP streams);
 * <p/>
