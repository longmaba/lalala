...
public class AudioDispatcher implements Runnable {
   ...
   * the previous buffer. Overlap should be smaller (strict) than the buffer
   * size and can be zero. Defined in number of samples.
   */
   ...
   * with this method: it should be called after a batch of samples is
   ...
   * until the normal amount of elements are present in the buffer. Otherwise
   * the buffer only contains the last elements and no zeros. By default it is
   * set to true.
   *
