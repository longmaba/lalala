...
/**
 * The continuing silence detector does not break the audio processing pipeline
...
public class SilenceDetector implements AudioProcessor {
   ...
   *
   * @param silenceThreshold The threshold which defines when a buffer is silent
   * (in dB). Normal values are [-70.0,-30.0] dB SPL.
