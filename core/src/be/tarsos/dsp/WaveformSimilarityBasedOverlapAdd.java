...
public class WaveformSimilarityBasedOverlapAdd implements AudioProcessor {
  ...
  /**
   * Create a new instance based on algorithm parameters for a certain audio
   * format.
   *
   ...
   * @param postion The position where to start the seek operation, in the input
   * buffer.
  ...
  /**
   * An object to encapsulate some of the parameters for WSOLA, together with a
   * couple of practical helper functions.
   *
   * @author Joren Six
   */
  public static class Parameters {
    ...
    /**
     * @param tempo The tempo change 1.0 means unchanged, 2.0 is + 100% , 0.5 is
     * half of the speed.
     * @param sampleRate The sample rate of the audio 44.1kHz is common.
     * @param newSequenceMs Length of a single processing sequence, in
     * milliseconds. This determines to how long sequences the original sound is
     ...
     * @param newSeekWindowMs Seeking window length in milliseconds for
     * algorithm that finds the best possible overlapping location. This
     * determines from how wide window the algorithm may look for an optimal
     * joining location when mixing the sound sequences back together.
     * <p/>
     ...
     * <p/>
     * If there's a disturbing artifact that sounds as if a constant frequency
     * was drifting around, try reducing this setting.
     * <p/>
     * Increasing this value increases computational burden & vice versa.
     * @param newOverlapMs Overlap length in milliseconds. When the chopped
