...
public class SpectralPeakProcessor implements AudioProcessor {
   ...
   * determine if the information is either noise or an interesting spectral
   * peak.
   ...
   * decide to examine candidates who score above the 90th percentile (0.9). The
   * elements of the input array are modified (sorted) by this method.
   *
