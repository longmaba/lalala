...
public class PitchProcessor implements AudioProcessor {
  ...
  public enum PitchEstimationAlgorithm {
    ...
    FFT_PITCH,
    /**
     * A pitch extractor that extracts the Average Magnitude Difference (AMDF)
     * from an audio buffer. This is a good measure of the Pitch (f0) of a
     * signal.
     */
    AMDF;

    /**
     * Returns a new instance of a pitch detector object based on the provided
     * values.
     *
