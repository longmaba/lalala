...
public class DTMF {
   ...
   * href="http://en.wikipedia.org/wiki/Dual-tone_multi-frequency_signaling"
   * >WikiPedia article on DTMF</a> for the relation between the characters and
   * frequencies.
   */
   ...
   * @return a float buffer of predefined length (7168 samples) with the correct
   * DTMF tone representing the character.
   */
   ...
   * @return True if the given character is present in DTMF_CHARACTERS, false
   * otherwise.
   */
