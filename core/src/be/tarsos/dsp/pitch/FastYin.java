 ...
 * >the YIN paper.</a> This implementation is done by <a
 * href="mailto:matthias.mauch@elec.qmul.ac.uk">Matthias Mauch</a> and is based
 * on {@link Yin} which is based on the implementation found in <a
...
public final class FastYin implements PitchDetector {
  ...
  /**
   * The default YIN threshold value. Should be around 0.10~0.15. See YIN paper
  ...
  /**
   * Buffer to allow convolution via complex multiplication. It calculates the
   ...
   * @param audioSampleRate The sample rate of the audio stream. E.g. 44.1 kHz.
   * @param bufferSize The size of a buffer. E.g. 1024.
   * @param yinThreshold The parameter that defines which peaks are kept as
   * possible pitch candidates. See the YIN paper for more details.
   */
  ...
  /**
   * The main flow of the YIN algorithm. Returns a pitch value in Hz or -1 if no
   * pitch is detected.
   *
   ...
   * with an FFT to reduce the number of operations.
   */
