...
/**
 * A pitch detector is capable of analyzing a buffer with audio information and
 * return a pitch estimation in Hz.
 *
 * @author Joren Six
 */
public interface PitchDetector {
   ...
   *
   * @param audioBuffer The buffer with audio information. The information in
   * the buffer is not modified so it can be (re)used for e.g. FFT analysis.
