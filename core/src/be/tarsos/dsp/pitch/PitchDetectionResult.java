 ...
 * together with the pitch. The exact meaning of the value depends on the
 * detector used.</li>
 ...
 * <p/>
 * <p/>
 * For performance reasons the object is reused. Please create a copy of the
 * object if you want to use it on an other thread.
 *
 * @author Joren Six
 */
public class PitchDetectionResult {
  ...
  /**
   * A copy constructor. Since PitchDetectionResult objects are reused for
   * performance reasons, creating a copy can be practical.
   *
   * @param other
   */
   ...
   * term voiced which is used in speech recognition. This probability should be
   * calculated together with the pitch. The exact meaning of the value depends
  ...
  /**
   * @return Whether the algorithm thinks the block of audio is pitched. Keep in
   * mind that an algorithm can come up with a best guess for a pitch even when
   * isPitched() is false.
   */
